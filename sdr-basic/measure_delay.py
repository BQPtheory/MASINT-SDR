...
def measure_delay(
    ...
    txTime0 = sdr.getHardwareTime() + int(0.1e9) #100ms
    ...
    receiveTime = txTime0 - int((numRxSamps/rate)*1e9)//2
    ...
    txPeakTime = txTime0 + int((txArgmaxIndex/rate)*1e9)
    rxPeakTime = rxTime0 + int((rxArgmaxIndex/rate)*1e9)
